...
public class GaussianRegressionAuthenticationMethod {
	private Integer grRegressionAuthId;
	...
	public GaussianRegressionAuthenticationMethod() {

	}

	public GaussianRegressionAuthenticationMethod(Integer grRegressionAuthId, String authMethod, boolean oauth2Support,
			String jwtSubject, String issuer, String audience, long issuedAt, String federalIdentitySupport,
			String creationDate, String modifiedDate, String entityState) {
		super();
		this.grRegressionAuthId = grRegressionAuthId;
	...
	public Integer getGrRegressionAuthId() {
		return grRegressionAuthId;
	}

	public void setGrRegressionAuthId(Integer grRegressionAuthId) {
		this.grRegressionAuthId = grRegressionAuthId;
	}
